...
WebUI.verifyElementText(findTestObject('Object Repository/Page_XYZ Bank/strong_1007'), '1007')

WebUI.click(findTestObject('Object Repository/Page_XYZ Bank/span_Ron Weasly'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_XYZ Bank/span_Ron Weasly'), 'Ron Weasly')
